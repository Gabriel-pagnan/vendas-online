...
export const ProductInsert = () => {
    ...
    const { isEdit, handleCancel, handleSave, onChangeInput, handleChangeSelect, disabledButton, loading, product, loadingProduct } = useInsertProduct(productId);
                    ...
                    <LimitedContainer width={400}>
                        ...
                        <DisplayFlexJustifyRight>
                            ...
                            <LimitedContainer width={120}>
                                <Button loading={loading} disabled={disabledButton} onClick={handleSave} margin="20px 0" type="primary" icon={<CheckOutlined />}>
